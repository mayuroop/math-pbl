...
Emp_name; int Age;
 ...
 Tax = 0.1 * (Annual_income - 500000);

 } else if (Annual_income <= 5000000) {

 Tax = 0.1 * 500000 + 0.2 * (Annual_income - 1000000);

 }

 System.out.println("Income Tax for " + Emp_name + " (Emp ID: " + Emp_id + ") is: Rs. " +
...
Emp_name;
 ...
 int Age; double Salary; double Employee_contribution;

double Employer_contribution; public PensionCalculator(int id,
...
public static void main(String[] args) {
 ...
 PensionCalculator employee = new PensionCalculator(1, "Tushar", 45, 100000);
